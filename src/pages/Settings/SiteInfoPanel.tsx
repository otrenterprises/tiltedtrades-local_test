  ...
  return (
    <div className="bg-secondary rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between p-4 md:p-5 text-left hover:bg-tertiary/30 transition-colors"
      >
  ...
  return (
    <div className="space-y-3 md:space-y-4">
      ...
      <CollapsibleSection title="Navigation Toggles" defaultOpen={false}>
        ...
        <div className="bg-tertiary rounded-lg p-4 border border-theme mb-4">
          <h4 className="text-sm font-semibold text-primary mb-3">Mobile Quick Access Icons</h4>
          <p className="text-sm text-secondary mb-3">
            On mobile devices, you'll see compact icon buttons in the top-right corner of page headers:
          </p>
          <div className="flex items-center gap-4 mb-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center border border-theme">
              ...
              <span className="text-sm text-secondary">Net / Gross P&L</span>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-secondary">FIFO / Per Position</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-tertiary rounded-lg p-4 border border-theme">
            <h4 className="text-sm font-semibold text-primary mb-3">P&L Display: Net / Gross</h4>
          ...
          <div className="bg-tertiary rounded-lg p-4 border border-theme">
            <h4 className="text-sm font-semibold text-primary mb-3">P&L Method: FIFO / Per Position</h4>
            <div className="space-y-3">
              <div>
      ...
      <CollapsibleSection title="Main Sections" defaultOpen={false}>
        <div className="space-y-3">
          {sections.map((section) => (
            <div
              key={section.title}
              className="bg-tertiary rounded-lg p-4 border border-theme"
            >
      ...
      <CollapsibleSection title="Uploading Your Data" defaultOpen={false}>
        ...
        <div className="bg-caution/10 border border-caution/30 rounded-lg p-4 mb-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-secondary mb-3">
                Your upload file <strong className="text-primary">MUST</strong> be a Statement Report downloaded directly from CQG QTrader.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-tertiary rounded-lg p-4 border border-theme mb-4">
          <h4 className="text-sm font-semibold text-primary mb-3">How to Download from QTrader</h4>
          <ol className="text-sm text-secondary space-y-2.5 list-decimal list-inside">
            <li>Open the <span className="text-primary font-medium">Orders & Positions</span> screen</li>
            <li>Click <span className="text-primary font-medium">Setup → Statement Reports</span></li>
            <li>Click <span className="text-primary font-medium">Configure Columns</span>:
              <ul className="ml-6 mt-1.5 space-y-1 list-disc list-inside text-tertiary">
                ...
                <li>Click <span className="text-primary">OK</span></li>
              </ul>
            </li>
            <li>Check <span className="text-primary font-medium">Excel Spreadsheet</span> and select your date range</li>
            ...
            <li>Click <span className="text-primary font-medium">OK</span> to download</li>
          </ol>
        </div>

        {/* File Requirements */}
        <div className="bg-tertiary rounded-lg p-4 border border-theme mb-4">
          <h4 className="text-sm font-semibold text-primary mb-3">File Requirements</h4>
          <ul className="text-sm text-secondary space-y-1.5 list-disc list-inside">
            ...
            <li>File format: <span className="text-primary">.xlsx</span> or <span className="text-primary">.xls</span></li>
          </ul>
          <p className="text-sm text-tertiary mt-3 italic">
        ...
        <div className="bg-tertiary rounded-lg p-4 border border-theme">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-primary">Quick Start</h4>
          </div>
