    ...
    <div className={`min-h-screen bg-gray-900 py-8 px-4 transition-all duration-300 ${isExpanded ? 'ml-60' : 'ml-16'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400">Compete with traders worldwide and track your ranking</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="text-gray-300">Show only verified traders</span>
              </label>
            </div>
          </div>
        </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            {badge ? (
                              ...
                              <span className="text-gray-400 font-medium mr-2">#{rank}</span>
                            )}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
