    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
      <div className="bg-secondary border border-theme rounded-lg p-4 md:p-6">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs md:text-sm text-tertiary">Total Deposits</p>
      ...
      <div className="bg-secondary border border-theme rounded-lg p-4 md:p-6">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs md:text-sm text-tertiary">Total Withdrawals</p>
      ...
      <div className="bg-secondary border border-theme rounded-lg p-4 md:p-6">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs md:text-sm text-tertiary">Total Fees</p>
      ...
      <div className="bg-secondary border border-theme rounded-lg p-4 md:p-6">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs md:text-sm text-tertiary">Bulk Commission Adj.</p>
